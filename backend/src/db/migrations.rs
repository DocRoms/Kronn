...
const MIGRATIONS: &[(&str, &str)] = &[
    ...
    (
        "168_discussion_questions",
        include_str!("sql/168_discussion_questions.sql"),
    ),
    (
    ...
    (
        "176_discussion_effort_snapshots",
        include_str!("sql/176_discussion_effort_snapshots.sql"),
    ),
    (
