...
const BUILTIN_SKILLS: &[BuiltinSkill] = &[
    ...
    BuiltinSkill {
        id: "rust",
        content: include_str!("../skills/rust.md"),
    },
    BuiltinSkill {
        id: "typescript",
        content: include_str!("../skills/typescript.md"),
    },
    BuiltinSkill {
        id: "python",
        content: include_str!("../skills/python.md"),
    },
    BuiltinSkill {
        id: "go",
        content: include_str!("../skills/go.md"),
    },
    BuiltinSkill {
        id: "php",
        content: include_str!("../skills/php.md"),
    },
    BuiltinSkill {
        id: "java",
        content: include_str!("../skills/java.md"),
    },
    BuiltinSkill {
        id: "kotlin",
        content: include_str!("../skills/kotlin.md"),
    },
    BuiltinSkill {
        id: "swift",
        content: include_str!("../skills/swift.md"),
    },
    BuiltinSkill {
        id: "csharp",
        content: include_str!("../skills/csharp.md"),
    },
    // Domain
    BuiltinSkill {
        id: "security",
        content: include_str!("../skills/security.md"),
    },
    BuiltinSkill {
        id: "devops",
        content: include_str!("../skills/devops.md"),
    },
    BuiltinSkill {
        id: "data-engineering",
        content: include_str!("../skills/data-engineering.md"),
    },
    BuiltinSkill {
        id: "database",
        content: include_str!("../skills/database.md"),
    },
    BuiltinSkill {
        id: "terraform",
        content: include_str!("../skills/terraform.md"),
    },
    BuiltinSkill {
        id: "testing",
    ...
    BuiltinSkill {
        id: "api-design",
        content: include_str!("../skills/api-design.md"),
    },
    BuiltinSkill {
        id: "mobile",
        content: include_str!("../skills/mobile.md"),
    },
    BuiltinSkill {
        id: "workflow-architect",
        content: include_str!("../skills/workflow-architect.md"),
    },
    BuiltinSkill {
        id: "bootstrap-architect",
        content: include_str!("../skills/bootstrap-architect.md"),
    },
    ...
    BuiltinSkill {
        id: "kronn-doc-author",
        content: include_str!("../skills/kronn-doc-author.md"),
    },
    // Business
    BuiltinSkill {
        id: "seo",
        content: include_str!("../skills/seo.md"),
    },
    BuiltinSkill {
        id: "web-performance",
        content: include_str!("../skills/web-performance.md"),
    },
    BuiltinSkill {
        id: "green-it",
        content: include_str!("../skills/green-it.md"),
    },
    BuiltinSkill {
        id: "accessibility",
        content: include_str!("../skills/accessibility.md"),
    },
    BuiltinSkill {
        id: "gdpr",
        content: include_str!("../skills/gdpr.md"),
    },
    // Meta
    BuiltinSkill {
        id: "structured-questions",
        content: include_str!("../skills/structured-questions.md"),
    },
    ...
    BuiltinSkill {
        ...
        content: include_str!("../skills/external/test-driven-development.md"),
    },
    BuiltinSkill {
        id: "systematic-debugging",
        content: include_str!("../skills/external/systematic-debugging.md"),
    },
    BuiltinSkill {
        id: "writing-plans",
        content: include_str!("../skills/external/writing-plans.md"),
    },
    BuiltinSkill {
        id: "brainstorming",
        content: include_str!("../skills/external/brainstorming.md"),
    },
    BuiltinSkill {
        id: "verification-before-completion",
        content: include_str!("../skills/external/verification-before-completion.md"),
    },
    BuiltinSkill {
        id: "requesting-code-review",
        content: include_str!("../skills/external/requesting-code-review.md"),
    },
    BuiltinSkill {
        id: "receiving-code-review",
        content: include_str!("../skills/external/receiving-code-review.md"),
    },
    BuiltinSkill {
        id: "finishing-a-development-branch",
        content: include_str!("../skills/external/finishing-a-development-branch.md"),
    },
];
...
fn parse_auto_triggers_block(yaml: &str) -> Option<crate::models::AutoTriggers> {
    ...
    let mut locales: std::collections::HashMap<String, Vec<String>> =
...
mod tests {
    ...
    fn parse_builtin_skills() {
        ...
        assert!(
            skills.len() >= 22,
            "Expected at least 22 builtin skills, got {}",
            skills.len()
        );
    ...
    fn all_three_categories_represented() {
        let skills = list_all_skills();
        assert!(
            skills.iter().any(|s| s.category == SkillCategory::Language),
            "No language skills"
        );
        assert!(
            skills.iter().any(|s| s.category == SkillCategory::Domain),
            "No domain skills"
        );
        assert!(
            skills.iter().any(|s| s.category == SkillCategory::Business),
            "No business skills"
        );
    }
...
body"#;
        ...
        assert_eq!(
            skill.auto_triggers.as_ref().unwrap().common,
            vec!["pdf".to_string()]
        );
    }
    ...
    fn workflow_architect_skill_teaches_new_step_types() {
        ...
        assert!(
            c.contains("0 tokens") || c.contains("zero token") || c.contains("Zero tokens"),
        ...
        assert!(
            c.contains("decision tree") || c.contains("Decision tree"),
    ...
    fn workflow_architect_skill_teaches_feasibility_gated_pattern() {
        ...
        assert!(
            c.contains("on_invalid"),
            "skill must document the TypedSchema `on_invalid` flag"
        );
        assert!(
            c.contains("\"Fail\"") || c.contains("`Fail`"),
        ...
        assert!(
            c.contains("feasibility-autopilot"),
    ...
    fn workflow_architect_skill_teaches_reuse_and_helpers() {
        ...
        assert!(
            c.contains("CustomApiAiHelper")
                || c.contains("Custom API AI helper")
                || c.contains("curl"),
        ...
        assert!(
            c.contains("Reuse-first") || c.contains("reuse-first") || c.contains("Reuse first"),
    ...
    fn workflow_architect_skill_teaches_bundle_protocol() {
        ...
        assert!(
            c.contains("/api/workflows/bundle"),
    ...
    fn workflow_architect_skill_requires_api_plugin_slug_and_post_emission_disclaimer() {
        ...
        assert!(
            c.contains("/rest/api/3/") || c.contains("/repos/{owner}/{repo}"),
        ...
        assert!(
            c.to_lowercase().contains("custom api plugin"),
        ...
        assert!(
            c.contains("api_plugin_slug") && c.contains("quick_prompt_id"),
    ...
    fn bootstrap_architect_skill_writes_docs_agents_and_chains_skills() {
        ...
        let s = skills
            .iter()
            .find(|s| s.id == "bootstrap-architect")
        ...
        assert!(
            c.to_lowercase().contains("legacy `ai/`")
                || c.to_lowercase().contains("deprecated in 0.7.1"),
    ...
    fn kronn_docs_skill_is_disambiguated_and_uses_generic_placeholders() {
        ...
        let s = skills
            .iter()
            .find(|s| s.id == "Kronn Docs")
            .or_else(|| {
                skills
                    .iter()
                    .find(|s| s.id.eq_ignore_ascii_case("kronn-docs"))
            })
        ...
        assert!(
            d.contains("pdf") || d.contains("docx") || d.contains("xlsx"),
    ...
    fn structured_questions_skill_documents_parser_gotchas() {
        ...
        let s = skills
            .iter()
            .find(|s| s.id == "structured-questions")
    ...
    fn qp_improver_skill_teaches_strict_output_protocol() {
        ...
        assert!(
            c.to_lowercase().contains("skill_ids")
                && c.to_lowercase().contains("profile_ids")
                && c.to_lowercase().contains("directive_ids"),
        ...
        assert!(
            c.contains("Never invent a variable") || c.contains("never invent"),
    ...
    fn architect_skills_teach_mcp_draft_creation_tools() {
        ...
        let c = &arch.content;
        assert!(
            c.contains("workflow_create_draft"),
        ...
        assert!(
            qpc.contains("KRONN:QP_IMPROVED")
    ...
    fn workflow_architect_skill_teaches_canonical_envelope_and_signal_coverage() {
        ...
        assert!(
            c.contains("---STEP_OUTPUT---") && c.contains("---END_STEP_OUTPUT---"),
        ...
        // working around that).
        assert!(
            c.contains("`Notify`") && c.contains("[SIGNAL: ERROR]"),
            "skill must teach that Notify emits `[SIGNAL: ERROR]` on non-2xx (0.8.5+)"
        );
        assert!(
            c.contains("`BatchQuickPrompt`") && c.contains("[SIGNAL: PARTIAL]"),
