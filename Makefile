...
start:
	...
	@echo "$(CYAN)  ║   $(YELLOW)Services running.$(CYAN)                   ║$(RESET)"
	@echo "$(CYAN)  ║                                       ║$(RESET)"
	@echo "$(CYAN)  ║   → $(GREEN)http://localhost:$(PORT)$(CYAN)          ║$(RESET)"
	@echo "$(CYAN)  ║                                       ║$(RESET)"
	@echo "$(CYAN)  ║   $(RESET)kronn stop$(CYAN)     Arreter              ║$(RESET)"
	@echo "$(CYAN)  ║   $(RESET)kronn logs$(CYAN)     Voir les logs        ║$(RESET)"
	@echo "$(CYAN)  ║   $(RESET)kronn restart$(CYAN)  Redemarrer           ║$(RESET)"
	@echo "$(CYAN)  ║                                       ║$(RESET)"
	@echo "$(CYAN)  ╚═══════════════════════════════════════╝$(RESET)"
	@echo ""
