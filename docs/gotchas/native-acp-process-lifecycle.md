...
[src: file: backend/src/acp.rs:465-509]
[src: file: backend/src/acp.rs:567]
...
abort.
[src: file: backend/src/acp.rs:482-501]
...
`abort` only requests cancellation. That cancellation is logged, not returned as
an error: the task IS stopped and nothing leaks, while
...
provider error. The claim stops at the drain; a descendant holding the inherited
pipe is not Kronn's to terminate.
[src: file: backend/src/acp.rs:1164-1196]
...
socket event.
[src: file: backend/src/acp.rs:2303-2444]
...
[src: file: backend/src/acp.rs:2197-2288]
