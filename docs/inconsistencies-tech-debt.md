...
| TD-20260807-litellm-integration-missing | **Closed 2026-08-30.** LiteLLM execution and native tools shipped first; 0.12.0 adds named LiteLLM/NVIDIA/Other connections, authenticated connection tests, tier mappings, alias routing, legacy migration and the [operations guide](operations/external-api-connections.md). Per-model tool capability detection remains tracked separately in `TD-20260808-http-agents-no-tool-calling`. Detail: `docs/tech-debt/TD-20260807-litellm-integration-missing.md`. [src: file: backend/src/models/external_api_connection.rs:5-30] [src: file: backend/src/api/external_api_connections.rs:130-171] [src: file: backend/src/db/external_api_connections.rs:223-285] | Backend / Agents | Closed |
