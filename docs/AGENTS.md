...
| Planification | Planned (0.9.1) | One global task model exposed as a discussion-plan side panel and a prioritized backlog, with compact MCP reads/writes and attributable agent changes. `[src: file: docs/design/planning-and-discussion-plans.md:1-175]` |
