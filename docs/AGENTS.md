...
| Planification | Done (0.9.1) | Shared ranked tasks/subtasks, DoD, links/tags/blockers, project/discussion relations, attributable activity, global backlog, discussion side panel, compact MCP reads/writes, delta-only context notice and human-gated agent proposal cards. `[src: file: docs/design/planning-and-discussion-plans.md:1-181]` |
