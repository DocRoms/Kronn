...
from the measured job in every mode. Runs 33438929531, 33441299481 and
33472489642 now prove the complete sequence: the bounded warmup survives its
post-job save, two independent subsequent runs record verified compiled-cache
hits, and the measured backend job remains between 13m 16s and 13m 33s without
removing any blocking functional or quality gate.
