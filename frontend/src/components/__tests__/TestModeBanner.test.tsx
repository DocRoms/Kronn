...
function disc(overrides: Partial<Discussion> = {}): Discussion {
  return {
    ...
    participants: ['ClaudeCode' as any], messages: [], message_count: 0, non_system_message_count: 0, tier: "default" as const, summary_strategy: "OnDemand" as const, introspection_call_count: 0,
