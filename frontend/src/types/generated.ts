// ╔═══════════════════════════════════════════════════════════════════════════╗
// ║  SEMI-GENERATED — mirrors the Rust models (ts-rs bindings), with            ║
// ║  deliberate frontend simplifications (u64→number, some optionals, widened   ║
// ║  JsonValue). NOT auto-overwritten. When you add/change a Rust model field:  ║
// ║   • run `make typegen` — regenerates backend/bindings/ and FAILS if a       ║
// ║     field here drifts from the model (scripts/check-types-drift.mjs).        ║
// ║   • add the missing field(s) from backend/bindings/<Name>.ts.               ║
// ║  CI runs the same drift guard, so forgetting a field fails the build.        ║
// ╚═══════════════════════════════════════════════════════════════════════════╝
...
export interface AppConfig {
  ...
  disabled_agents: Array<AgentType>;
}
