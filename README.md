...
> **Status: 0.9.2 (current release).** Functional but pre-1.0. Breaking changes happen between minor versions; patch versions are safe.
...
```bash
git clone --branch 0.9.2 --depth 1 https://github.com/DocRoms/Kronn.git   # latest stable release
cd Kronn
